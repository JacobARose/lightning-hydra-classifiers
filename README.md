...
1. [ ] Implement full code logging using wandb logger
2. [ ] Implement full confusion matrix logging that flexibly formats the plot to look good regardless of whether num_classes is large or small.
3. [ ] 
4. [x] Create bash script to re-generate all datasets in one line


## Getting Started


To generate all datasets at all resolutions & thresholds, run:
