...
#     def train(self, force_train_bn: bool=False):
#         print(f"Running model.train(force_train_bn={force_train_bn})")
#         if force_train_bn:
#             super().train()
            
#         else:
#             self.unfreeze(self.model, unfreeze_bn=False)
...
#         if not hasattr(cls.method_calls["freeze"], "set_requires_grad=False"):
#             cls.method_calls["freeze"]["set_requires_grad=False"] = []
...
#         if not hasattr(cls.method_calls["unfreeze"], "set_requires_grad=True"):
#             cls.method_calls["unfreeze"]["set_requires_grad=True"] = []
...
#                 print(f"Skipping unfreeze bn layer: {n}")
#                 continue
#             cls.unfreeze_bn(m, unfreeze_bn)
#             for p_name, p in m.named_parameters():
#                 cls.method_calls["unfreeze"]["set_requires_grad=True"].append(f"module:{n}-param:{p_name}")
...
#         if not hasattr(cls.method_calls["freeze_bn"], "set_requires_grad=False"):
...
#                 for p_name, p in m.named_parameters():
#                     p.requires_grad = False
#                     cls.method_calls["freeze_bn"]["set_requires_grad=False"].append(f"module:{n}-param:{p_name}")
...
#         if not hasattr(cls.method_calls["unfreeze_bn"], "set_requires_grad=True"):
...
#                 for p_name, p in m.named_parameters():
#                     p.requires_grad = True
#                     cls.method_calls["unfreeze_bn"]["set_requires_grad=True"].append(f"module:{n}-param:{p_name}")
...
#         if not hasattr(cls.method_calls["set_bn_eval"], "called_modules"):
#             cls.method_calls["set_bn_eval"]["called_modules"] = []
...
#         cls.method_calls["set_bn_eval"]["called_modules"].extend(bn_mods)
