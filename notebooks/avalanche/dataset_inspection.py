...
python "/media/data/jacob/GitHub/lightning-hydra-classifiers/notebooks/avalanche/dataset_inspection.py"
"""
...
def main(cuda: int):
    ...
    # --- SCENARIO CREATION
    scenario = SplitCIFAR10(dataset_root=default_root_dir, n_experiences=2, seed=42)
    # ---------
