...
python "/media/data/jacob/GitHub/lightning-hydra-classifiers/notebooks/multihead.py"
"""
...
def main(args):
    ...
    scenario = SplitMNIST(dataset_root=default_root_dir, n_experiences=5, return_task_id=True)
