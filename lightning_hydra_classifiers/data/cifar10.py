"""
contrastive_learning.data.pytorch.cifar10

Utility functions for loading images from the useful toy dataset CIFAR10 into TorchVision dataloaders

Created by: Wednesday May 1st, 2021
Author: Jacob A Rose
