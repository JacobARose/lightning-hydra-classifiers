...
class ClassifierHead(BaseModule):
...
#         return params
    ...
    def remove_head(self):
        """
        Garbage collection the classifier head, if it exists
        """
    ...
    def replace_head(self, *args, **kwargs) -> None:
        """Copy the origin fully connected layer"""
        self.head = self.build_head(*args, **kwargs)
